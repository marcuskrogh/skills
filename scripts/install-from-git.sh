...
action. Use is and has. Skip sales language, leftover chatbot closings, and em
dashes. Say "Cursor" or "Claude Code", not "the harness"; "I'll check", not
...
Language: before any reply the operator will see, read
`.agents/skills/concepts/CONCEPT_LANGUAGE.md`,
`.agents/skills/concepts/LANGUAGE-PHRASES.md`, and
`.agents/skills/concepts/LANGUAGE-HUMANIZER.md`. Write short, precise, ordinary
...
First sentence is the fact or the next action. Use is and has. Skip sales
language, leftover chatbot closings, and em dashes. Say "Cursor" or "Claude
Code", not "the harness"; "I'll check", not "Let me dive in"; "in the code", not
"under the hood".
