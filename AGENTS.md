...
[`CONCEPT_LANGUAGE`](skills/concepts/CONCEPT_LANGUAGE.md) and
[`LANGUAGE-PHRASES`](skills/concepts/LANGUAGE-PHRASES.md). Write short, precise,
ordinary English. Spell names in full (`GeneralProcessSimulator`, not `GPS`).
