...
Applies the alignment [format override](../base/alignment/SKILL.md#format-overrides) for mathematical topics. Read with [reference.md](reference.md) for notation.
