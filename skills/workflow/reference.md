...
- **One open delivery branch + PR** per Task from the first repo-writing skill
  through ship.
- **First writer starts** the branch/PR (research / model / define / bug / tweak / refine when
...
| **implement** | PLAN/BUG/TWEAK/REFINE/ITERATE ready | Code on **same** PR; Task → In Review | `/review-fix` |
...
| `BUG.md` / `TWEAK.md` / `REFINE.md` / `ITERATE.md` / `PLAN.md` | bug / tweak / refine / iterate / define | Spec + keys + **Next** |
