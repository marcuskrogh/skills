...
| **adopt** | Task (or Story + area Tasks); link ADOPT.md; start frontier delivery branch/PR; then apply frontier (implement contract) | **In Progress** after apply; non-frontier Tasks stay **To Do** | Task/Story: ADOPT.md + branch/PR + inventory + **Next**; ISSUES | — |
