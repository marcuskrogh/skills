...
| Slot | This skill |
|------|------------|
| **Spec source** | `ITERATE.md` + new Task (+ prior PLAN/BUG/TWEAK/ITERATE as context) |
...
1. **Resolve lineage** — Fetch prior Task, merged PR, and PLAN/BUG/TWEAK/ITERATE; apply Prior context resolution. Done when lineage is identified per the concept stop, or an open-PR fix-forward handoff is reported.
...
- Spec context: PLAN.md | BUG.md | TWEAK.md | prior ITERATE.md | …
