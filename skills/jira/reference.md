...
| State | Used by |
|-------|---------|
| **To Do** / **Backlog** | New tickets from explore, define, model |
...
## Artifact
- Repo: `path/to/PLAN.md` (or BUG.md / TWEAK.md / REFINE.md / REWORK.md / ADOPT.md / ITERATE.md; commit SHA if applicable)
- Attached: MODEL.md
