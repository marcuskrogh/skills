...
| Put it here | When |
|-------------|------|
| **Route Task** | Sharp enough to hand to `/research`, `/model`, `/define`, `/bug`, `/tweak`, `/refine`, or a concrete unblocker — even if blocked |
...
3. **Handle a clear direct path** — If the work is already small and fog-free, select the direct handoff instead of manufacturing route Tasks. Done when `/define`, `/bug`, `/tweak`, `/refine`, or the concrete action is identified.
