...
3. **Handle a clear direct path** — If the work is already small and fog-free, select the direct handoff instead of manufacturing route Tasks. Done when `/define`, `/bug`, `/tweak`, or the concrete action is identified.
