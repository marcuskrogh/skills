...
- **Classify and bind when the skill requires it.** Skills that apply [CONCEPT_CLASSIFICATION](CONCEPT_CLASSIFICATION.md) persist class + workflow binding on the definition artifact so later stages stay deterministic.
