...
- **Proportional depth.** Full for non-trivial features; lightweight for clear defects, tweaks, and refinements; confirm gaps only when already implementation-ready.
...
| **Definition artifact** | must | Format and filename (`PLAN.md`, `BUG.md`, `TWEAK.md`, `REFINE.md`, …) |
