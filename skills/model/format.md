...
Applies the alignment [format override](../concepts/CONCEPT_ALIGNMENT.md#extensions) for mathematical topics. Read with [reference.md](reference.md) for notation.
